  ...
  return (
    <section className="relative w-full h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to bottom, rgba(0,0,0,0.25) 0%, transparent 40%, transparent 60%, var(--bg) 100%)",
        }}
      />
...
const VALUES = [
  {
    number: "01",
    title: "Precision",
    body: "Every stitch engineered to perform at altitude and on the ground. No excess. No compromise.",
  },
  {
    number: "02",
    title: "Heritage",
    body: "Rooted in aviation culture, inspired by the men and women of the flight line across every era.",
  },
  {
    number: "03",
    title: "Function",
    body: "Garments designed for real movement, real conditions, real pilots — not the fashion runway.",
  },
] as const;
        ...
        >
          {VALUES.map((value) => (
            <motion.div key={value.number} variants={fadeUp}>
              {/* Large number */}
              <p
                className="text-7xl lg:text-8xl font-bold leading-none mb-4 select-none"
                style={{
                  fontFamily: "var(--font-rajdhani)",
                  color: "var(--accent)",
                  opacity: 0.35,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 xl:gap-20 items-start">
          ...
          >
            ...
            <div
              className="absolute inset-0"
              style={{
                background: "radial-gradient(ellipse at 40% 60%, rgba(200,169,110,0.07) 0%, transparent 65%)",
              }}
            />
            ...
            >
              <span
                className="text-[clamp(48px,8vw,96px)] font-bold uppercase tracking-widest opacity-[0.06]"
  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.h2
          variants={fadeUp}
          className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold uppercase leading-none"
          style={{ fontFamily: "var(--font-rajdhani)", color: "var(--text)" }}
        >
          Cleared for
          <br />
